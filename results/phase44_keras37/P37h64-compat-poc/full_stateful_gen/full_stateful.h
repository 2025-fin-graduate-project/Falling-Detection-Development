/**
  ...
  ******************************************************************************
  */
#ifndef STAI_FULL_STATEFUL_H
#define STAI_FULL_STATEFUL_H
...
#define STAI_FULL_STATEFUL_ORIGIN_MODEL_NAME         "model"
#define STAI_FULL_STATEFUL_ORIGIN_MODEL_SIGNATURE    "0x759e2d5902530abd074eafe61269e63e"

/*  Generated model name and signature  */
#define STAI_FULL_STATEFUL_MODEL_NAME                "full_stateful"
#define STAI_FULL_STATEFUL_MODEL_SIGNATURE           (0x3266be1763a73314)


/*****************************************************************************/
/*  Macros to declare network context size and required alignment  */
#define STAI_FULL_STATEFUL_CONTEXT_ALIGNMENT   8
#define STAI_FULL_STATEFUL_CONTEXT_SIZE        (sizeof(_stai_full_stateful_context))

/*  Macro to declare network flags  */
#define STAI_FULL_STATEFUL_FLAGS               (STAI_FLAG_STATES|STAI_FLAG_INPUTS|STAI_FLAG_OUTPUTS|STAI_FLAG_WEIGHTS)

/*  Macro to declare number of network C nodes generated  */
#define STAI_FULL_STATEFUL_NODES_NUM           (10)

/*  Macro to declare number macc for generated network model  */
#define STAI_FULL_STATEFUL_MACC_NUM            (2760992)

/*  Macros to declare input buffers characteristics  */
#define STAI_FULL_STATEFUL_IN_NUM              (1)
#define STAI_FULL_STATEFUL_IN_SIZE_BYTES       (7204)

#define STAI_FULL_STATEFUL_IN_ALIGNMENTS \
  { 4}
#define STAI_FULL_STATEFUL_IN_NAMES \
  { NULL}
#define STAI_FULL_STATEFUL_IN_FORMATS \
  { STAI_FORMAT_FLOAT32}
#define STAI_FULL_STATEFUL_IN_SIZES \
  {1800}
#define STAI_FULL_STATEFUL_IN_SIZES_BYTES \
  {7200}

#define STAI_FULL_STATEFUL_IN_1_ALIGNMENT   4
#define STAI_FULL_STATEFUL_IN_1_NAME        (NULL)
#define STAI_FULL_STATEFUL_IN_1_FLAGS       (STAI_FLAG_INPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_LAST|STAI_FLAG_HAS_BATCH)
#define STAI_FULL_STATEFUL_IN_1_FORMAT      (STAI_FORMAT_FLOAT32)
#define STAI_FULL_STATEFUL_IN_1_SHAPE       {1,40,45}
#define STAI_FULL_STATEFUL_IN_1_BATCH       (1)
#define STAI_FULL_STATEFUL_IN_1_HEIGHT      (40)
#define STAI_FULL_STATEFUL_IN_1_CHANNEL     (45)
#define STAI_FULL_STATEFUL_IN_1_RANK        (2)
#define STAI_FULL_STATEFUL_IN_1_SIZE        (1800)
#define STAI_FULL_STATEFUL_IN_1_SIZE_BYTES  (7200)

/*****************************************************************************/
/*  Macros to declare output buffers characteristics  */
#define STAI_FULL_STATEFUL_OUT_NUM             (1)
#define STAI_FULL_STATEFUL_OUT_SIZE_BYTES      (12)
#define STAI_FULL_STATEFUL_OUT_ALIGNMENTS \
  { 4}
#define STAI_FULL_STATEFUL_OUT_NAMES \
  { NULL}
#define STAI_FULL_STATEFUL_OUT_FORMATS \
  { STAI_FORMAT_FLOAT32}
#define STAI_FULL_STATEFUL_OUT_SIZES \
  { 2}
#define STAI_FULL_STATEFUL_OUT_SIZES_BYTES \
  {8}

#define STAI_FULL_STATEFUL_OUT_1_ALIGNMENT   4
#define STAI_FULL_STATEFUL_OUT_1_NAME        (NULL)
#define STAI_FULL_STATEFUL_OUT_1_FLAGS       (STAI_FLAG_OUTPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_LAST|STAI_FLAG_HAS_BATCH)
#define STAI_FULL_STATEFUL_OUT_1_FORMAT      (STAI_FORMAT_FLOAT32)
#define STAI_FULL_STATEFUL_OUT_1_SHAPE       {1,2}
#define STAI_FULL_STATEFUL_OUT_1_BATCH       (1)
#define STAI_FULL_STATEFUL_OUT_1_CHANNEL     (2)
#define STAI_FULL_STATEFUL_OUT_1_RANK        (1)
#define STAI_FULL_STATEFUL_OUT_1_SIZE        ((2))
#define STAI_FULL_STATEFUL_OUT_1_SIZE_BYTES  (8)

/*****************************************************************************/
/*  Macros to declare activations buffers characteristics  */
#define STAI_FULL_STATEFUL_ACTIVATIONS_SIZE              (22016)
#define STAI_FULL_STATEFUL_ACTIVATIONS_SIZE_BYTES        (22016)
#define STAI_FULL_STATEFUL_ACTIVATIONS_ALIGNMENTS \
  { 4}
#define STAI_FULL_STATEFUL_ACTIVATIONS_SIZES \
  { 22016}
#define STAI_FULL_STATEFUL_ACTIVATIONS_NUM               (1)

#define STAI_FULL_STATEFUL_ACTIVATION_1_FLAGS      (STAI_FLAG_ACTIVATIONS)
#define STAI_FULL_STATEFUL_ACTIVATION_1_SIZE       (22016)
#define STAI_FULL_STATEFUL_ACTIVATION_1_SIZE_BYTES (22016)
#define STAI_FULL_STATEFUL_ACTIVATION_1_ALIGNMENT  4
/*  Macros to declare weights buffers characteristics  */

#define STAI_FULL_STATEFUL_WEIGHTS_NUM                  (1)
#define STAI_FULL_STATEFUL_WEIGHTS_SIZE                  (281992)
#define STAI_FULL_STATEFUL_WEIGHTS_SIZE_BYTES            (281992)
#define STAI_FULL_STATEFUL_WEIGHTS_ALIGNMENTS \
  { 4}
#define STAI_FULL_STATEFUL_WEIGHTS_SIZES \
  { 281992}
#define STAI_FULL_STATEFUL_WEIGHTS_NUM        (1)
#define STAI_FULL_STATEFUL_WEIGHT_1_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_FULL_STATEFUL_WEIGHT_1_SIZE        (281992)
#define STAI_FULL_STATEFUL_WEIGHT_1_SIZE_BYTES  (281992)


/*****************************************************************************/
/*  Macros to declare states buffers characteristics  */
#define STAI_FULL_STATEFUL_STATES_SIZE              (0)
#define STAI_FULL_STATEFUL_STATES_SIZE_BYTES        (0)
#define STAI_FULL_STATEFUL_STATES_ALIGNMENTS        {}
#define STAI_FULL_STATEFUL_STATES_SIZES             { 0, }
#define STAI_FULL_STATEFUL_STATES_NUM               (0)

#define STAI_FULL_STATEFUL_STATE_1_FLAGS            (0x0)
#define STAI_FULL_STATEFUL_STATE_1_ALIGNMENT        4
#define STAI_FULL_STATEFUL_STATE_1_SIZE             (0)
#define STAI_FULL_STATEFUL_STATE_1_SIZE_BYTES       (0)
/*****************************************************************************/
...
typedef struct {
  ...
  stai_ptr                     _activations[STAI_FULL_STATEFUL_ACTIVATIONS_NUM];
  stai_ptr                     _weights[STAI_FULL_STATEFUL_WEIGHTS_NUM];
  stai_ptr                     _inputs[STAI_FULL_STATEFUL_IN_NUM];
  stai_ptr                     _outputs[STAI_FULL_STATEFUL_OUT_NUM];
} _stai_full_stateful_context;
 ...
 *          @ref STAI_FULL_STATEFUL_CONTEXT_SIZE or @ref stai_full_stateful_get_context_size(void) API
 ...
 *          on the input buffers whose memory adresses are retrived using @ref stai_full_stateful_get_inputs() API.
 *          Alternatively the application could allocate the inputs and set the addresses using the
 *          @ref stai_full_stateful_set_inputs() API. Similar behaviour is expected for the network outputs handling.
 *          The features of each input / output buffer (format, byte size, etc.)may be queried using
 *          @ref stai_full_stateful_get_info() API or the set of specific macros available in this header file.
 ...
 *          @ref stai_full_stateful_get_outputs() API.
 * @param[in] network network context opaque pointer
 ...
 */
STAI_API_ENTRY
stai_size stai_full_stateful_get_context_size(void);
 ...
 *          @ref stai_full_stateful_set_states() dual API
 * @param[in] network network context opaque pointer
 ...
 *          @ref stai_full_stateful_run() API. It is a helper routine that could be used by an application for debug
