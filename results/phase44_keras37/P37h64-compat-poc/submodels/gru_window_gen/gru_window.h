/**
  ...
  ******************************************************************************
  */
#ifndef STAI_GRU_WINDOW_H
#define STAI_GRU_WINDOW_H
...
#define STAI_GRU_WINDOW_ORIGIN_MODEL_NAME         "gru_window_mode"
#define STAI_GRU_WINDOW_ORIGIN_MODEL_SIGNATURE    "0xf0a2c486ecf1a710437d300680e63770"

/*  Generated model name and signature  */
#define STAI_GRU_WINDOW_MODEL_NAME                "gru_window"
#define STAI_GRU_WINDOW_MODEL_SIGNATURE           (0x3803d29f8e923aff)


/*****************************************************************************/
/*  Macros to declare network context size and required alignment  */
#define STAI_GRU_WINDOW_CONTEXT_ALIGNMENT   8
#define STAI_GRU_WINDOW_CONTEXT_SIZE        (sizeof(_stai_gru_window_context))

/*  Macro to declare network flags  */
#define STAI_GRU_WINDOW_FLAGS               (STAI_FLAG_INPUTS|STAI_FLAG_OUTPUTS|STAI_FLAG_WEIGHTS)

/*  Macro to declare number of network C nodes generated  */
#define STAI_GRU_WINDOW_NODES_NUM           (2)

/*  Macro to declare number macc for generated network model  */
#define STAI_GRU_WINDOW_MACC_NUM            (1359360)

/*  Macros to declare input buffers characteristics  */
#define STAI_GRU_WINDOW_IN_NUM              (1)
#define STAI_GRU_WINDOW_IN_SIZE_BYTES       (10244)

#define STAI_GRU_WINDOW_IN_ALIGNMENTS \
  { 4}
#define STAI_GRU_WINDOW_IN_NAMES \
  { NULL}
#define STAI_GRU_WINDOW_IN_FORMATS \
  { STAI_FORMAT_FLOAT32}
#define STAI_GRU_WINDOW_IN_SIZES \
  {2560}
#define STAI_GRU_WINDOW_IN_SIZES_BYTES \
  {10240}

#define STAI_GRU_WINDOW_IN_1_ALIGNMENT   4
#define STAI_GRU_WINDOW_IN_1_NAME        (NULL)
#define STAI_GRU_WINDOW_IN_1_FLAGS       (STAI_FLAG_INPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_LAST|STAI_FLAG_HAS_BATCH)
#define STAI_GRU_WINDOW_IN_1_FORMAT      (STAI_FORMAT_FLOAT32)
#define STAI_GRU_WINDOW_IN_1_SHAPE       {1,40,64}
#define STAI_GRU_WINDOW_IN_1_BATCH       (1)
#define STAI_GRU_WINDOW_IN_1_HEIGHT      (40)
#define STAI_GRU_WINDOW_IN_1_CHANNEL     (64)
#define STAI_GRU_WINDOW_IN_1_RANK        (2)
#define STAI_GRU_WINDOW_IN_1_SIZE        (2560)
#define STAI_GRU_WINDOW_IN_1_SIZE_BYTES  (10240)

/*****************************************************************************/
/*  Macros to declare output buffers characteristics  */
#define STAI_GRU_WINDOW_OUT_NUM             (1)
#define STAI_GRU_WINDOW_OUT_SIZE_BYTES      (132)
#define STAI_GRU_WINDOW_OUT_ALIGNMENTS \
  { 4}
#define STAI_GRU_WINDOW_OUT_NAMES \
  { NULL}
#define STAI_GRU_WINDOW_OUT_FORMATS \
  { STAI_FORMAT_FLOAT32}
#define STAI_GRU_WINDOW_OUT_SIZES \
  { 32}
#define STAI_GRU_WINDOW_OUT_SIZES_BYTES \
  {128}

#define STAI_GRU_WINDOW_OUT_1_ALIGNMENT   4
#define STAI_GRU_WINDOW_OUT_1_NAME        (NULL)
#define STAI_GRU_WINDOW_OUT_1_FLAGS       (STAI_FLAG_OUTPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_LAST|STAI_FLAG_HAS_BATCH)
#define STAI_GRU_WINDOW_OUT_1_FORMAT      (STAI_FORMAT_FLOAT32)
#define STAI_GRU_WINDOW_OUT_1_SHAPE       {1,32}
#define STAI_GRU_WINDOW_OUT_1_BATCH       (1)
#define STAI_GRU_WINDOW_OUT_1_CHANNEL     (32)
#define STAI_GRU_WINDOW_OUT_1_RANK        (1)
#define STAI_GRU_WINDOW_OUT_1_SIZE        ((32))
#define STAI_GRU_WINDOW_OUT_1_SIZE_BYTES  (128)

/*****************************************************************************/
/*  Macros to declare activations buffers characteristics  */
#define STAI_GRU_WINDOW_ACTIVATIONS_SIZE              (22016)
#define STAI_GRU_WINDOW_ACTIVATIONS_SIZE_BYTES        (22016)
#define STAI_GRU_WINDOW_ACTIVATIONS_ALIGNMENTS \
  { 4}
#define STAI_GRU_WINDOW_ACTIVATIONS_SIZES \
  { 22016}
#define STAI_GRU_WINDOW_ACTIVATIONS_NUM               (1)

#define STAI_GRU_WINDOW_ACTIVATION_1_FLAGS      (STAI_FLAG_ACTIVATIONS)
#define STAI_GRU_WINDOW_ACTIVATION_1_SIZE       (22016)
#define STAI_GRU_WINDOW_ACTIVATION_1_SIZE_BYTES (22016)
#define STAI_GRU_WINDOW_ACTIVATION_1_ALIGNMENT  4
/*  Macros to declare weights buffers characteristics  */

#define STAI_GRU_WINDOW_WEIGHTS_NUM                  (1)
#define STAI_GRU_WINDOW_WEIGHTS_SIZE                  (137472)
#define STAI_GRU_WINDOW_WEIGHTS_SIZE_BYTES            (137472)
#define STAI_GRU_WINDOW_WEIGHTS_ALIGNMENTS \
  { 4}
#define STAI_GRU_WINDOW_WEIGHTS_SIZES \
  { 137472}
#define STAI_GRU_WINDOW_WEIGHTS_NUM        (1)
#define STAI_GRU_WINDOW_WEIGHT_1_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_GRU_WINDOW_WEIGHT_1_SIZE        (137472)
#define STAI_GRU_WINDOW_WEIGHT_1_SIZE_BYTES  (137472)


/*****************************************************************************/
/*  Macros to declare states buffers characteristics  */
#define STAI_GRU_WINDOW_STATES_SIZE              (0)
#define STAI_GRU_WINDOW_STATES_SIZE_BYTES        (0)
#define STAI_GRU_WINDOW_STATES_ALIGNMENTS        {}
#define STAI_GRU_WINDOW_STATES_SIZES             { 0, }
#define STAI_GRU_WINDOW_STATES_NUM               (0)

#define STAI_GRU_WINDOW_STATE_1_FLAGS            (0x0)
#define STAI_GRU_WINDOW_STATE_1_ALIGNMENT        4
#define STAI_GRU_WINDOW_STATE_1_SIZE             (0)
#define STAI_GRU_WINDOW_STATE_1_SIZE_BYTES       (0)
/*****************************************************************************/
...
typedef struct {
  ...
  stai_ptr                     _activations[STAI_GRU_WINDOW_ACTIVATIONS_NUM];
  stai_ptr                     _weights[STAI_GRU_WINDOW_WEIGHTS_NUM];
  stai_ptr                     _inputs[STAI_GRU_WINDOW_IN_NUM];
  stai_ptr                     _outputs[STAI_GRU_WINDOW_OUT_NUM];
} _stai_gru_window_context;
 ...
 *          @ref STAI_GRU_WINDOW_CONTEXT_SIZE or @ref stai_gru_window_get_context_size(void) API
 ...
 *          on the input buffers whose memory adresses are retrived using @ref stai_gru_window_get_inputs() API.
 *          Alternatively the application could allocate the inputs and set the addresses using the
 *          @ref stai_gru_window_set_inputs() API. Similar behaviour is expected for the network outputs handling.
 *          The features of each input / output buffer (format, byte size, etc.)may be queried using
 *          @ref stai_gru_window_get_info() API or the set of specific macros available in this header file.
 ...
 *          @ref stai_gru_window_get_outputs() API.
 * @param[in] network network context opaque pointer
 ...
 */
STAI_API_ENTRY
stai_size stai_gru_window_get_context_size(void);
 ...
 *          @ref stai_gru_window_set_states() dual API
 * @param[in] network network context opaque pointer
 ...
 *          @ref stai_gru_window_run() API. It is a helper routine that could be used by an application for debug
