/**
  ...
  ******************************************************************************
  */
#ifndef STAI_CONV_SUBMODEL_H
#define STAI_CONV_SUBMODEL_H
...
#define STAI_CONV_SUBMODEL_ORIGIN_MODEL_NAME         "conv_submodel"
#define STAI_CONV_SUBMODEL_ORIGIN_MODEL_SIGNATURE    "0xdd2c82bf808a5ac853845c923a7e9030"

/*  Generated model name and signature  */
#define STAI_CONV_SUBMODEL_MODEL_NAME                "conv_submodel"
#define STAI_CONV_SUBMODEL_MODEL_SIGNATURE           (0x675a7b1b87bc1532)


/*****************************************************************************/
/*  Macros to declare network context size and required alignment  */
#define STAI_CONV_SUBMODEL_CONTEXT_ALIGNMENT   8
#define STAI_CONV_SUBMODEL_CONTEXT_SIZE        (sizeof(_stai_conv_submodel_context))

/*  Macro to declare network flags  */
#define STAI_CONV_SUBMODEL_FLAGS               (STAI_FLAG_INPUTS|STAI_FLAG_OUTPUTS|STAI_FLAG_WEIGHTS)

/*  Macro to declare number of network C nodes generated  */
#define STAI_CONV_SUBMODEL_NODES_NUM           (4)

/*  Macro to declare number macc for generated network model  */
#define STAI_CONV_SUBMODEL_MACC_NUM            (1400448)

/*  Macros to declare input buffers characteristics  */
#define STAI_CONV_SUBMODEL_IN_NUM              (1)
#define STAI_CONV_SUBMODEL_IN_SIZE_BYTES       (7204)

#define STAI_CONV_SUBMODEL_IN_ALIGNMENTS \
  { 4}
#define STAI_CONV_SUBMODEL_IN_NAMES \
  { NULL}
#define STAI_CONV_SUBMODEL_IN_FORMATS \
  { STAI_FORMAT_FLOAT32}
#define STAI_CONV_SUBMODEL_IN_SIZES \
  {1800}
#define STAI_CONV_SUBMODEL_IN_SIZES_BYTES \
  {7200}

#define STAI_CONV_SUBMODEL_IN_1_ALIGNMENT   4
#define STAI_CONV_SUBMODEL_IN_1_NAME        (NULL)
#define STAI_CONV_SUBMODEL_IN_1_FLAGS       (STAI_FLAG_INPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_LAST|STAI_FLAG_HAS_BATCH)
#define STAI_CONV_SUBMODEL_IN_1_FORMAT      (STAI_FORMAT_FLOAT32)
#define STAI_CONV_SUBMODEL_IN_1_SHAPE       {1,40,45}
#define STAI_CONV_SUBMODEL_IN_1_BATCH       (1)
#define STAI_CONV_SUBMODEL_IN_1_HEIGHT      (40)
#define STAI_CONV_SUBMODEL_IN_1_CHANNEL     (45)
#define STAI_CONV_SUBMODEL_IN_1_RANK        (2)
#define STAI_CONV_SUBMODEL_IN_1_SIZE        (1800)
#define STAI_CONV_SUBMODEL_IN_1_SIZE_BYTES  (7200)

/*****************************************************************************/
/*  Macros to declare output buffers characteristics  */
#define STAI_CONV_SUBMODEL_OUT_NUM             (1)
#define STAI_CONV_SUBMODEL_OUT_SIZE_BYTES      (10244)
#define STAI_CONV_SUBMODEL_OUT_ALIGNMENTS \
  { 4}
#define STAI_CONV_SUBMODEL_OUT_NAMES \
  { NULL}
#define STAI_CONV_SUBMODEL_OUT_FORMATS \
  { STAI_FORMAT_FLOAT32}
#define STAI_CONV_SUBMODEL_OUT_SIZES \
  { 2560}
#define STAI_CONV_SUBMODEL_OUT_SIZES_BYTES \
  {10240}

#define STAI_CONV_SUBMODEL_OUT_1_ALIGNMENT   4
#define STAI_CONV_SUBMODEL_OUT_1_NAME        (NULL)
#define STAI_CONV_SUBMODEL_OUT_1_FLAGS       (STAI_FLAG_OUTPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_LAST|STAI_FLAG_HAS_BATCH)
#define STAI_CONV_SUBMODEL_OUT_1_FORMAT      (STAI_FORMAT_FLOAT32)
#define STAI_CONV_SUBMODEL_OUT_1_SHAPE       {1,40,64}
#define STAI_CONV_SUBMODEL_OUT_1_BATCH       (1)
#define STAI_CONV_SUBMODEL_OUT_1_HEIGHT      (40)
#define STAI_CONV_SUBMODEL_OUT_1_CHANNEL     (64)
#define STAI_CONV_SUBMODEL_OUT_1_RANK        (2)
#define STAI_CONV_SUBMODEL_OUT_1_SIZE        ((40 * 64))
#define STAI_CONV_SUBMODEL_OUT_1_SIZE_BYTES  (10240)

/*****************************************************************************/
/*  Macros to declare activations buffers characteristics  */
#define STAI_CONV_SUBMODEL_ACTIVATIONS_SIZE              (14288)
#define STAI_CONV_SUBMODEL_ACTIVATIONS_SIZE_BYTES        (14288)
#define STAI_CONV_SUBMODEL_ACTIVATIONS_ALIGNMENTS \
  { 4}
#define STAI_CONV_SUBMODEL_ACTIVATIONS_SIZES \
  { 14288}
#define STAI_CONV_SUBMODEL_ACTIVATIONS_NUM               (1)

#define STAI_CONV_SUBMODEL_ACTIVATION_1_FLAGS      (STAI_FLAG_ACTIVATIONS)
#define STAI_CONV_SUBMODEL_ACTIVATION_1_SIZE       (14288)
#define STAI_CONV_SUBMODEL_ACTIVATION_1_SIZE_BYTES (14288)
#define STAI_CONV_SUBMODEL_ACTIVATION_1_ALIGNMENT  4
/*  Macros to declare weights buffers characteristics  */

#define STAI_CONV_SUBMODEL_WEIGHTS_NUM                  (1)
#define STAI_CONV_SUBMODEL_WEIGHTS_SIZE                  (140032)
#define STAI_CONV_SUBMODEL_WEIGHTS_SIZE_BYTES            (140032)
#define STAI_CONV_SUBMODEL_WEIGHTS_ALIGNMENTS \
  { 4}
#define STAI_CONV_SUBMODEL_WEIGHTS_SIZES \
  { 140032}
#define STAI_CONV_SUBMODEL_WEIGHTS_NUM        (1)
#define STAI_CONV_SUBMODEL_WEIGHT_1_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_CONV_SUBMODEL_WEIGHT_1_SIZE        (140032)
#define STAI_CONV_SUBMODEL_WEIGHT_1_SIZE_BYTES  (140032)


/*****************************************************************************/
/*  Macros to declare states buffers characteristics  */
#define STAI_CONV_SUBMODEL_STATES_SIZE              (0)
#define STAI_CONV_SUBMODEL_STATES_SIZE_BYTES        (0)
#define STAI_CONV_SUBMODEL_STATES_ALIGNMENTS        {}
#define STAI_CONV_SUBMODEL_STATES_SIZES             { 0, }
#define STAI_CONV_SUBMODEL_STATES_NUM               (0)

#define STAI_CONV_SUBMODEL_STATE_1_FLAGS            (0x0)
#define STAI_CONV_SUBMODEL_STATE_1_ALIGNMENT        4
#define STAI_CONV_SUBMODEL_STATE_1_SIZE             (0)
#define STAI_CONV_SUBMODEL_STATE_1_SIZE_BYTES       (0)
/*****************************************************************************/
...
typedef struct {
  ...
  stai_ptr                     _activations[STAI_CONV_SUBMODEL_ACTIVATIONS_NUM];
  stai_ptr                     _weights[STAI_CONV_SUBMODEL_WEIGHTS_NUM];
  stai_ptr                     _inputs[STAI_CONV_SUBMODEL_IN_NUM];
  stai_ptr                     _outputs[STAI_CONV_SUBMODEL_OUT_NUM];
} _stai_conv_submodel_context;
 ...
 *          @ref STAI_CONV_SUBMODEL_CONTEXT_SIZE or @ref stai_conv_submodel_get_context_size(void) API
 ...
 *          on the input buffers whose memory adresses are retrived using @ref stai_conv_submodel_get_inputs() API.
 *          Alternatively the application could allocate the inputs and set the addresses using the
 *          @ref stai_conv_submodel_set_inputs() API. Similar behaviour is expected for the network outputs handling.
 *          The features of each input / output buffer (format, byte size, etc.)may be queried using
 *          @ref stai_conv_submodel_get_info() API or the set of specific macros available in this header file.
 ...
 *          @ref stai_conv_submodel_get_outputs() API.
 * @param[in] network network context opaque pointer
 ...
 */
STAI_API_ENTRY
stai_size stai_conv_submodel_get_context_size(void);
 ...
 *          @ref stai_conv_submodel_set_states() dual API
 * @param[in] network network context opaque pointer
 ...
 *          @ref stai_conv_submodel_run() API. It is a helper routine that could be used by an application for debug
