#!/usr/bin/env bash
# Phase 21: train/checkpoint directly against validation event-level MinPR.

set -uo pipefail

OUTROOT="${OUTROOT:-results/phase21_event_minpr_checkpoint}"
...
log "=== Phase 21: val_event_min_pr checkpoint + event threshold selection ==="

# v01: direct event-MinPR checkpoint equivalent of P20-v01.
run_exp "P21-v01" --seed 42

# v02: P20-v03 variant, full negative exposure with event-MinPR checkpoint.
run_exp "P21-v02" --train-negative-stride 1 --seed 42
