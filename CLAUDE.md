...
This file and `AGENTS.md` must stay aligned. `AGENTS.md` is the short operational contract for coding agents; this file adds project-specific context for Claude and other agents.
...
- If push fails because credentials, remote policy, or network access are unavailable, report that clearly.
